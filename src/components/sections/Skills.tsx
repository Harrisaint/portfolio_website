      ...
      <div className="relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-4">
            <span className="gradient-text dark:gradient-text-dark">Skills</span>
          </h2>
          ...
          {skills.map((category, categoryIndex) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full p-8 rounded-3xl glass-light dark:glass-dark border border-gray-200/50 dark:border-gray-700/50 hover:border-blue-500/50 dark:hover:border-blue-400/50 transition-all shadow-xl hover:shadow-2xl">
                  {/* Category Header */}
                  ...
                  <div className="space-y-3">
                    {category.skills.map((skill, skillIndex) => (
                      ...
                      >
                        <div className="px-4 py-3 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-500/10 dark:to-purple-500/10 border border-blue-200/50 dark:border-blue-500/20 hover:border-blue-400 dark:hover:border-blue-400/50 transition-all cursor-default">
        ...
        <motion.div
          ...
          className="mt-16 max-w-4xl mx-auto p-8 rounded-3xl glass-light dark:glass-dark border border-gray-200/50 dark:border-gray-700/50"
        >
